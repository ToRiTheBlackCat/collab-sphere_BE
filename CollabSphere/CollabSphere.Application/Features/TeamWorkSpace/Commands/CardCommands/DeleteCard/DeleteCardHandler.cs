...
namespace CollabSphere.Application.Features.TeamWorkSpace.Commands.CardCommands.DeleteCard
{
    public class DeleteCardHandler : CommandHandler<DeleteCardCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        public DeleteCardHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task<CommandResult> HandleCommand(DeleteCardCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (foundCard != null)
                {
                    _unitOfWork.CardRepo.Delete(foundCard);
        ...
        protected override async Task ValidateRequest(List<OperationError> errors, DeleteCardCommand request)
        {
            //Find team workspace
