...
{
    public class DeleteTaskHandler : CommandHandler<DeleteTaskCommand>
    {
        ...
        protected override async Task<CommandResult> HandleCommand(DeleteTaskCommand request, CancellationToken cancellationToken)
        {
        ...
        protected override async Task ValidateRequest(List<OperationError> errors, DeleteTaskCommand request)
        {
            //Find team workspace
