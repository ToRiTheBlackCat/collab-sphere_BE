...
{
    public class MoveListHandler : CommandHandler<MoveListCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        public MoveListHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }
        protected override async Task<CommandResult> HandleCommand(MoveListCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (foundList != null)
                {
                    foundList.Position = request.NewPosition;
        ...
        protected override async Task ValidateRequest(List<OperationError> errors, MoveListCommand request)
        {
            //Find team workspace
