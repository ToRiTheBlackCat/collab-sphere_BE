...
{
    public class GetOtherEvaluationsForOwnInTeamHandler : QueryHandler<GetOtherEvaluationsForOwnInTeamQuery, GetOtherEvaluationsForOwnInTeamResult>
    {
        ...
        protected override async Task<GetOtherEvaluationsForOwnInTeamResult> HandleCommand(GetOtherEvaluationsForOwnInTeamQuery request, CancellationToken cancellationToken)
        {
            var result = new GetOtherEvaluationsForOwnInTeamResult()
            {
                IsSuccess = false,
                IsValidInput = true,
            ...
            try
            {
                ...
                if (foundTeam != null)
                {
                    ...
                    {
                        var dtoTasks = otherEvaluations.Select(async x => new OtherEvaluationsForOwnInTeamDto
                        {
                            RaterId = x.Key,
                            RaterName = (await _unitOfWork.UserRepo.GetOneByUIdWithInclude(x.Key))?.Student.Fullname,
