...
namespace CollabSphere.Application.DTOs.Notifications
{
    ...
    public static partial class NotificationMappings
    {
        ...
        public static List<NotificationDto> ToNotificationDtos(this IEnumerable<Notification> notifications)
        {
            return notifications.Select(notification => notification.ToNotificationDto()).ToList();
        }
    }
}
