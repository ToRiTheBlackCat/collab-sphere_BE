...
{
    public class DenyProjectTest
    {
        private readonly Mock<IUnitOfWork> _unitOfWorkMock;
        private readonly Mock<IProjectRepository> _projectRepoMock;

        private readonly DenyProjectHandler _handler;

        public DenyProjectTest()
        {
            ...
            _handler = new DenyProjectHandler(_unitOfWorkMock.Object);
        }
        ...
        {
            // Arrange
            var command = new DenyProjectCommand()
            {
                ProjectId = 1
            };
            ...
            _unitOfWorkMock.Verify(x => x.ProjectRepo.Update(It.Is<Project>(x => x.ProjectName.Equals("Project Name 1") && x.Status == ProjectStatuses.DENIED)), Times.Once);
            _unitOfWorkMock.Verify(x => x.CommitTransactionAsync(), Times.Once);
            Assert.Contains("'Project Name 1' denied", result.Message, StringComparison.OrdinalIgnoreCase);
        }
